...
private:
    ...
    Grid grid{m_xBoundaryMin, m_xBoundaryMax, m_yBoundaryMin, m_yBoundaryMax, static_cast<unsigned int>(m_rowSize), static_cast<unsigned int>(m_colSize), initialState};
