        ...
        f_solver = std::move(FiniteDifferenceSolver::FD_HPRDBC3D_Solver(
            HeatProblem::HeatProblemRectDBC3D(
                ...
                [](glm::dvec2 point, double t) {
                    return 3 * sin(1.1 * t) + 2 * cos(point.x + 0.9 * glm::pi<double>() * t) * cos(point.y + 0.9 * glm::pi<double>() * t);
                },
                [](glm::dvec2 point, double t) {
                    return 0;
                },
                [](glm::dvec2 point, double t) {
                    return 3 * sin(0.9 * t) + 2 * cos(point.x + 1.1 * glm::pi<double>() * t) * cos(point.y + 1.1 * glm::pi<double>() * t);
                },
                [](glm::dvec2 point, double t) {
                    return 3 * sin(1.15 * t) + 2 * cos(point.x + 0.85 * glm::pi<double>() * t) * cos(point.y + 0.85 * glm::pi<double>() * t);
                },
                [](glm::dvec2 point, double t) {
                    return 3 * sin(0.85 * t) + 2 * cos(point.x + 1.15 * glm::pi<double>() * t) * cos(point.y + 1.15 * glm::pi<double>() * t);
                },
                [](glm::dvec2 point, double t) {
                    return 3 * sin(1 * t) + 2 * cos(point.x + glm::pi<double>() * t) * cos(point.y + glm::pi<double>() * t);
                }
            )
        ));
