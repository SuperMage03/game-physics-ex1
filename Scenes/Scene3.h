...
private:
    float _step = 0.01f;
    // CuboidRigidBody _test_wall_a{glm::vec3(2.0f, 0.0f, 0.0f), glm::vec3(1.0f, 2.0f, 2.0f), glm::quat(1.0f, 0.0f, 0.0f, 0.0f), 999.0f, 1.0f, 0.0f, false};
    // CuboidRigidBody _test_wall_b{glm::vec3(-2.0f, 0.0f, 0.0f), glm::vec3(1.0f, 2.0f, 2.0f), glm::quat(1.0f, 0.0f, 0.0f, 0.0f), 999.0f, 1.0f, 0.0f, false};
