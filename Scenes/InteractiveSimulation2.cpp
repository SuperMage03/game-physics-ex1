...
void InteractiveSimulation2::init() {
    initializeRandomNoise(glm::vec2(1.0f, 1.0f), 16, 16);
}

void InteractiveSimulation2::onGUI() {
    const char* options[] = {"Explicit Euler scheme", "Implicit BTCS scheme"};
...
void InteractiveSimulation2::onDraw(Renderer& renderer) {
...
void InteractiveSimulation2::initializeRandomNoise(glm::vec2 domainExtent, 
...
void InteractiveSimulation2::explicitEulerSchemeStep() {
...
void InteractiveSimulation2::implicitBTCSSchemeStep() {
    std::vector<std::vector<float>> oldGrid = tempGrid.grid;
